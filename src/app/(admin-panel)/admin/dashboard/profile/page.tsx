      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-[var(--color-border-subtle)] rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-[var(--color-text-tertiary)] mb-1">Recovery Emails</label>
              <div className="text-sm text-[var(--color-text-primary)]">{admin.recoveryEmails.join(', ') || 'None set'}</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-[var(--color-border-subtle)] rounded-xl p-6 flex flex-col">
          ...
          <div className="mt-auto">
            <button className="px-4 py-2 rounded-lg bg-[var(--color-bg-base)] hover:bg-[var(--color-bg-elevated)] border border-[var(--color-border-default)] text-sm font-medium text-[var(--color-text-primary)] transition-colors">
              Change Password
            </button>
          </div>
        </div>
