...
import { Leaf, Mail, Phone, Sprout, Factory, Globe, Award, ArrowRight } from 'lucide-react'
          ...
          <div className="flex flex-wrap gap-3 pt-4 border-t border-[var(--color-border-subtle)]">
            {member.contacts.map((c: any) => (
              <a 
                ...
                rel="noreferrer"
                className="text-[var(--color-text-tertiary)] hover:text-[var(--color-green-600)] transition-colors"
